...
insert into systag(msoId, seq, type, featured, createDate, updateDate) values (3, 0,   2, false, now(), now());
insert into systag(msoId, seq, type, featured, createDate, updateDate) values (3, 0,   2, false, now(), now());
insert into systag(msoId, seq, type, featured, createDate, updateDate) values (3, 0,   2, false, now(), now());
...
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 23, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=4);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 24, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=5);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 25, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=6);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 26, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=7);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 27, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=8);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 28, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=9);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 29, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=10);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 30, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=11);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 31, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=12);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 32, name, null, lang, null, now(), channelCnt from category where msoId = 3 and seq=13);
# systag_display: nnset 9x9
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) values (33, 'Internet Daily', null, 'zh', null, now(), 11);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) values (34, 'Music Day',      null, 'zh', null, now(), 22);
# systag_display: nnset cts 
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 35, name, imageUrl, lang, null, now(), cntChannel from nnset where id=1);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 36, name, imageUrl, lang, null, now(), cntChannel from nnset where id=2);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 37, name, imageUrl, lang, null, now(), cntChannel from nnset where id=9);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 38, name, imageUrl, lang, null, now(), cntChannel from nnset where id=3);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 39, name, imageUrl, lang, null, now(), cntChannel from nnset where id=4);
...
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 41, name, imageUrl, lang, null, now(), cntChannel from nnset where id=10);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 42, name, imageUrl, lang, null, now(), cntChannel from nnset where id=11);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 43, name, imageUrl, lang, null, now(), cntChannel from nnset where id=12);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 44, name, imageUrl, lang, null, now(), cntChannel from nnset where id=13);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 45, name, imageUrl, lang, null, now(), cntChannel from nnset where id=5);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 46, name, imageUrl, lang, null, now(), cntChannel from nnset where id=6);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 47, name, imageUrl, lang, null, now(), cntChannel from nnset where id=7);
...
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 65,  name,       null, "zh", null, now(), 9 from dashboard where id=18);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 66,  name,       null, "zh", null, now(), 9 from dashboard where id=19);
insert into systag_display (systagId, name, imageUrl, lang, popularTag, updateDate, cntChannel) (select 67,  name,       null, "zh", null, now(), 9 from dashboard where id=20);
############################################
...
insert into systag_map (systagId, channelId, createDate, updateDate) (select 23, channelId, now(), now() from category_map where categoryId=42);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 24, channelId, now(), now() from category_map where categoryId=43);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 25, channelId, now(), now() from category_map where categoryId=44);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 26, channelId, now(), now() from category_map where categoryId=45);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 27, channelId, now(), now() from category_map where categoryId=46);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 28, channelId, now(), now() from category_map where categoryId=47);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 39, channelId, now(), now() from category_map where categoryId=48);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 30, channelId, now(), now() from category_map where categoryId=49);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 31, channelId, now(), now() from category_map where categoryId=50);
insert into systag_map (systagId, channelId, createDate, updateDate) (select 32, channelId, now(), now() from category_map where categoryID=51);
...
insert into systag_map (systagId, channelId, createDate, updateDate) (select 37, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=9)));
insert into systag_map (systagId, channelId, createDate, updateDate) (select 38, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=3)));
insert into systag_map (systagId, channelId, createDate, updateDate) (select 39, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=4)));
...
insert into systag_map (systagId, channelId, createDate, updateDate) (select 41, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=10)));
insert into systag_map (systagId, channelId, createDate, updateDate) (select 42, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=11)));
insert into systag_map (systagId, channelId, createDate, updateDate) (select 43, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=12)));
insert into systag_map (systagId, channelId, createDate, updateDate) (select 44, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=13)));
insert into systag_map (systagId, channelId, createDate, updateDate) (select 45, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=5)));
insert into systag_map (systagId, channelId, createDate, updateDate) (select 46, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=6)));
insert into systag_map (systagId, channelId, createDate, updateDate) (select 47, channelId, now(), now() from tag_map where tagId in (select id from tag where name = (select concat(name,'(ctszh)') from nnset where id=7)));

#systag_map: nnset 9x9
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 26825, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 8816,  now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 14381, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 14384, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 14383, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 14382, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 8599,  now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 8600,  now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 8601,  now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 8602,  now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (33, 14385, now(), now());

insert into systag_map (systagId, channelId, createDate, updateDate) values (34, 8763, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (34, 8784, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (34, 2659, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (34, 480, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (34, 483, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (34, 8800, now(), now());
insert into systag_map (systagId, channelId, createDate, updateDate) values (34, 8761, now(), now());
