...
$(document).ready(function () {
	...
	function initGA(){
		...
		$(gaEvents).bind("resumed", function(e, ch, ep, title){
			if(ep){
				reportGA("/view/ch" + ch + "/" + ep, title);
			}else{
				reportGA("/view/ch" + ch, title);
