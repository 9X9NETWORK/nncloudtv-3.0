...
<c:import charEncoding="UTF-8" url="http://s3-us-west-2.amazonaws.com/9x9pm1/facebook_app1/${brandName}/fanapp.html"/>

<script type="text/javascript">
   $(document).ready(function(){
        $("#androidUrl").attr("href", "${androidStoreUrl}");
        $("#iosUrl").attr("href", "${iosStoreUrl}");
   });
</script>
